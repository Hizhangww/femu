...
#include "common.h"
#include "ftl_inverse_mapping_manager.h"  //hsj add
...
struct ssdstate {
    ...
    empty_block_entry* curr_sequence_entry;  //hsj add
    empty_block_entry* curr_srand_entry;  //hsj add
    ...
    unsigned int sequence_empty_block_table_index;
    unsigned int srand_empty_block_table_index;
    ...
    //xyh add
    /* Used to store semantic information handed down from Linux */
    int64_t gtsc; 
    int gc_flag;
    int gc_gtsc;
    //xyh add
